                ...
                Forms\Components\Section::make('Informasi Penerima')
                    ->schema([
                        ...
                        Forms\Components\Select::make('attendance_id')
                            ->label('Absensi Terkait')
                            ->relationship('attendance', 'id', function ($query, $get) {
                            ...
                            ->preload()
                            ->nullable()
                            ->helperText('Opsional: Pilih absensi yang terkait dengan notifikasi ini'),
                ...
                Forms\Components\Section::make('Status Pengiriman')
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('whatsapp_message_id')
                            ...
                            ->disabled()
                            ->helperText('ID pesan dari WhatsApp API'),
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('resend')
                    ...
                    ->action(function ($record) {
                        // TODO: Implement resend notification logic
                        // WhatsAppService::resendNotification($record);
